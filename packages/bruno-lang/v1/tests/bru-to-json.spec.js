  ...
  it('should parse .bru file contents', () => {
    ...
    expect(result).toMatchObject({
      ...
      request: {
        ...
        params: [
          { enabled: true, name: 'apiKey', value: 'secret' },
          { enabled: true, name: 'numbers', value: '998877665' },
          { enabled: true, name: 'message', value: 'hello' },
        ],
        headers: [
          { enabled: true, name: 'content-type', value: 'application/json' },
          { enabled: true, name: 'accept-language', value: 'en-US,en;q=0.9,hi;q=0.8' },
        ...
        body: expect.objectContaining({
          ...
          formUrlEncoded: [
            { enabled: true, name: 'username', value: 'john' },
            { enabled: false, name: 'password', value: '{{password}}' },
          ],
          multipartForm: [
            { enabled: true, name: 'username', value: 'nash' },
            { enabled: false, name: 'password', value: 'governingdynamics' },
          ],
        }),
